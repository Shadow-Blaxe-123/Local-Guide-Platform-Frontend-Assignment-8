...
export default function AllBookingsCard({ booking }: { booking?: Booking }) {
  if (!booking) return <p className="text-center mt-8">No bookings found.</p>;
  ...
  return (
    ...
    >
      <CardHeader>
        ...
        <CardDescription>
          {booking.tour.city}, {booking.tour.country} • {booking.tour.duration}{" "}
          day(s)
        </CardDescription>
      </CardHeader>
