...
export default function AboutUsSection() {
  return (
    <section className="w-full bg-gray-50 dark:bg-slate-950" id="about">
      <div className="mx-auto max-w-7xl px-4 py-20">
        {/* Section Header */}
        <div className="mx-auto max-w-3xl text-center space-y-4">
          <h2 className="text-3xl font-bold tracking-tight text-purple-700 dark:text-purple-400 sm:text-4xl">
            About Guidely
          </h2>
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <Card className="border-none shadow-sm bg-white dark:bg-slate-900 dark:shadow-none">
            <CardContent className="p-6 space-y-4">
              <Users className="h-8 w-8 text-slate-900 dark:text-slate-100" />
          ...
          <Card className="border-none shadow-sm bg-white dark:bg-slate-900 dark:shadow-none">
            <CardContent className="p-6 space-y-4">
              <Map className="h-8 w-8 text-slate-900 dark:text-slate-100" />
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">
          ...
          <Card className="border-none shadow-sm bg-white dark:bg-slate-900 dark:shadow-none">
            <CardContent className="p-6 space-y-4">
              <HeartHandshake className="h-8 w-8 text-slate-900 dark:text-slate-100" />
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100">
                Empowering Locals
              </h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">
