        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {categories.map((cat) => (
            <Link
              ...
              key={cat.name}
              className={`group relative rounded-xl shadow-xl hover:shadow-2xl transition-shadow p-8 flex items-center justify-center ${cat.color} text-white font-semibold text-lg`}
            >
